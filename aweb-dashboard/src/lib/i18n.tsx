...
export const LANGUAGE_EVENT = "dashboard-language-changed";
...
const ENGLISH_DICTIONARY: Dictionary = {
  ...
  "sidebar.nudges": "Nudges",
  "sidebar.leaderboard": "Leaderboard",
  "sidebar.settings": "Settings",
  "dashboard.today": "Today",
  "dashboard.masterSchedule": "Master Schedule",
  "dashboard.pipeline.title": "Appointment Pipeline",
};
...
const HINDI_DICTIONARY: Dictionary = {
  ...
  "sidebar.admin": "व्यवस्थापन",
  "sidebar.schedule": "शेड्यूल",
  "sidebar.mappings": "मैपिंग",
  "sidebar.nudges": "नज",
  "sidebar.leaderboard": "लीडरबोर्ड",
  "sidebar.settings": "सेटिंग",
  "dashboard.today": "आज",
  "dashboard.masterSchedule": "मास्टर शेड्यूल",
  "dashboard.pipeline.title": "अपॉइंटमेंट पाइपलाइन",
};
...
const I18nContext = createContext<I18nContextValue>({
  language: "en",
  t: (key) => ENGLISH_DICTIONARY[key] ?? key,
  setLanguage: () => {},
  enabled: true,
});
...
export function I18nProvider({ children }: { children: React.ReactNode }) {
  ...
  return (
    <I18nContext.Provider value={{ language, t, setLanguage, enabled: I18N_ENABLED }}>
      {children}
